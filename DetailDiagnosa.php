...
where analisahasil.id_log ='".$_GET['id_log']."' and analisahasil.id_pengguna='".$_SESSION['id_pengguna']."'
...
$qry_solusi4 = mysql_query($sql_solusi3, $koneksi);
    ...
    <tr bgcolor="">	
      ...
      <td valign="top" bgcolor=""><div align="right">
        <span class="style5">
        <a href="Cetak.php?id_log=<?php echo $_GET['id_log']; ?>&id_pengguna=<?php echo $_SESSION['id_pengguna']; ?>" target="_blank" class="btn btn-warning">Cetak Hasil</a>
      </span></div></td>
      <td valign="top" bgcolor="">&nbsp;</td>
    </tr>
  </table>
