...
<form method="post" action="PenyakitAddSim.php">
    <table border="0" cellpadding="2" cellspacing="1">
      <tr bgcolor="" valign="top"> 
        <td width="112">Kode</td>
      <td width="677" bgcolor=""><input name="TxtKode" type="text"  maxlength="10" size="" value="<?php echo kdauto("hamapenyakit","P"); ?>" disabled="disabled">
        <input name="TxtKodeH" type="hidden" value="<?php echo kdauto("hamapenyakit","P"); ?>"></td>
    </tr>
      
      <tr bgcolor="" valign="top">
        <td bgcolor="">Jenis Penyakit  </td>
        <td bgcolor=""><input name="TxtPenyakit" type="text" id="TxtPenyakit" maxlength="30" required></td>
    </tr>
      
      <tr bgcolor="" valign="top">
        <td bgcolor="">Keterangan</td>
        <td bgcolor=""><textarea name="TxtKeterangan" cols="40" rows="4" id="TxtKeterangan" required></textarea></td>
    </tr>
      <tr bgcolor=""> 
        <td bgcolor="">&nbsp;</td>
      <td bgcolor=""><input type="submit" name="Submit" class="btn btn-info" value="Simpan"> <a href="javascript:history.back()" class="btn btn-warning">Batal</a></td>
    </tr>
    </table>
</form>
