...
$kdubah=$_GET['id_artikel'];
if($kdubah !=""){
	#Menampilkan Data
	$sql = "SELECT * FROM artikel WHERE id_artikel='$kdubah'";
...
<form action="ArtikelSave.php" method="post" name="form1" target="_self">
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="">

    <tr bgcolor="" valign="top"> 
      <td>Judul</td>
      <td><input name="judul" type="search" style="width:60%;" value="<?php echo $judul; ?>" required></td>
    </tr>
    <tr bgcolor="" valign="top"> 
      <td width="77">Artikel</td>
      <td><textarea name="artikel" class="ckeditor" cols="35" rows="3" required><?php echo $artikel; ?></textarea></td>
    </tr>
    <tr bgcolor=""> 
      <td>&nbsp;</td>
      ...
      <input type="hidden" name="id_param" value="<?php echo $id_artikel; ?>">
    </tr>
  </table>
</form>
