...
<form action="RelasiAddSim.php" method="post" name="form1" target="_self" id="form1">
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bordercolor="#000000">
    <tr>
      <td colspan="2" bordercolor="#006600" bgcolor="">Nama Hama Dan Penyakit: </td>
    </tr>
    <tr>
      <td colspan="2" bordercolor="#006600" bgcolor=""><select name="CmbPenyakit" onChange="MM_jumpMenu('parent',this,0)">
    ...
    <tr>
      <td colspan="2" bordercolor="#006600" bgcolor="">Daftar Gejala : </td>
    </tr>
	<?php
	...
	while ($data=mysql_fetch_array($qry)){
		...
		$sqlr .= "WHERE id_penyakit='$kdsakit'";
		...
		?>
    <tr bgcolor="">
      <td width="31" bordercolor="#000000" bgcolor="">
	  <input name="CekGejala[]" type="checkbox" value="<?= $data['id_gejala'];?>" <?= $cek; ?> >
	  </td>
      <td width="755" bordercolor="#000000" bgcolor=""><? echo $data['gejala'];?></td>
    </tr>
	<?php
	}
	?>
