...
if($kdubah !=""){
	#Menampilkan Data
	$sql = "SELECT * FROM solusi WHERE id_solusi='$kdubah'";
	...
	$TxtKodeH = $data['id_solusi'];
	$TxtGejala = $data['solusi'];
}
?>
...
<form action="SolusiEditSim.php" method="post" name="form1" target="_self">
