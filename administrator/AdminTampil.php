...
<table class='table table-striped table-condensed'>
  <tr>
    <td width="32">No</td> 
    <td width="142"><strong>IdUser</strong></td>
    <td width="479"><strong>User Name</strong></td>
    <td width="118" align="center"><b>Pilihan</b></td>
  </tr>
  <?php 
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td align="center"><a href="AdminAddFm.php" class="btn">Tambah</a></td>
  </tr>
  <tr>
    <td height="104">&nbsp;</td> 
    <td>&nbsp;</td>
