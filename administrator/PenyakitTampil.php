...
<table class='table table-striped table-condensed'>
  <tr> 
    ...
    <td width="142"><strong>Id Penyakit </strong></td>
    <td width="488"><strong><b>Jenis Penyakit </b></strong></td>
    <td width="108" align="center"><b>Aksi</b></td>
  </tr>
  <?php 
  $sql = "SELECT Id_Pnykt,JnsPnykt FROM hamapenyakit ORDER BY Id_Pnykt";
  ...
  <tr> 
    <td><?php echo $no; ?></td>
    <td><?php echo $data['Id_Pnykt']; ?></td>
    <td><?php echo $data['JnsPnykt']; ?></td>
    <td align="center"> 
    <a href="PenyakitHapus.php?kdhapus=<? echo $data['Id_Pnykt']; ?>" target="_self" class="btn">Delete</a>
    <a href="PenyakitEditFm.php?kdubah=<? echo $data['Id_Pnykt']; ?>" target="_self" class="btn">Edit</a></td>
  </tr>
  <?php
  }
  ?>
  <tr> 
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><div align="center"><a href="RelasiAddPilih.php" class="btn">Relasi Penyakit Dengan Gejala </a></div></td>
    <td align="center"><a href="PenyakitAddFm.php" class="btn">Tambah</a></td>
  </tr>
</table>
