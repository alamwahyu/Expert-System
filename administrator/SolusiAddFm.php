...
<form action="SolusiAddSim.php" method="post" name="form1" target="_self"><div align="center">
  <table width="100%">
    <tr bgcolor="" valign="top"> 
      <td>Kode</td>
      <td><input name="TxtKode" type="text"  maxlength="10" size="12" value="<? echo kdauto("solusi","S"); ?>" disabled="disabled">
        <input name="TxtKodeH" type="hidden" value="<? echo kdauto("solusi","S"); ?>"></td>
    </tr>
    <tr bgcolor="" valign="top"> 
      <td width="66">Gejala</td>
      <td width="686"><textarea name="TxtGejala" cols="35" rows="3"></textarea></td>
    </tr>
    <tr bgcolor="" valign="top"> 
      <td>&nbsp;</td>
