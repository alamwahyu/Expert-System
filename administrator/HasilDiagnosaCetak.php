...
$_SESSION['id_log'] = $_GET['id_log'];
$_SESSION['id_pengguna'] = $_GET['id_pengguna'];
...
//gejala yang sesuai dan ada
  $sql_gejalaada = "select distinct gejala.* FROM gejala, relasi WHERE gejala.id_gejala= relasi.id_gejala AND relasi.id_gejala in (select id_gejala from analisahasil where id_log in ((select max(id_log) from log where id_log='".$_SESSION['id_log']."' and id_pengguna='".$_SESSION['id_pengguna']."')))";
...
<div class="alert">
    ...
    $sql_gejala = "select distinct gejala.* FROM gejala, relasi WHERE gejala.id_gejala= relasi.id_gejala AND relasi.id_gejala in (select id_gejala from analisahasil where id_log in ((select max(id_log) from log where id_log='".$_SESSION['id_log']."' and id_pengguna='".$_SESSION['id_pengguna']."')))";
