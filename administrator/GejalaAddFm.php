...
<form action="GejalaAddSim.php" method="post" name="form1" target="_self"><div align="center">
  <table width="100%" border="0" cellpadding="2" cellspacing="1">
    <tr bgcolor="" valign="top"> 
      <td>Kode</td>
      <td><input name="TxtKode" type="text"  maxlength="10" size="12" value="<? echo kdauto("gejala","G"); ?>" disabled="disabled">
        <input name="TxtKodeH" type="hidden" value="<? echo kdauto("gejala","G"); ?>"></td>
    </tr>
    <tr bgcolor="" valign="top"> 
      <td width="66">Gejala</td>
      <td width="686" bgcolor=""><textarea name="TxtGejala" cols="35" rows="3" required></textarea></td>
    </tr>
    <tr bgcolor=""> 
      <td>&nbsp;</td>
      <td><input type="submit" name="Submit" class="btn btn-info" value="Simpan"> <a href="javascript:history.back()" class="btn btn-warning">Batal</a></td>
    </tr>
  </table>
</form>
