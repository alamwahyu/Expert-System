...
$kdubah=$_GET['id_pages'];
if($kdubah !=""){
	#Menampilkan Data
	$sql = "SELECT * FROM pages WHERE id_pages='$kdubah'";
...
<form action="PagesSave.php" method="post" name="form1" target="_self">
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="">

    <tr bgcolor="" valign="top"> 
      <td>Tipe</td>
      <td><input name="judul" type="search" style="width:60%;" value="<?php echo $tipe; ?>" required disabled></td>
    </tr>
    <tr bgcolor="" valign="top"> 
      <td width="77">Isi</td>
      <td><textarea name="isi" class="ckeditor" cols="35" rows="3" required><?php echo $isi; ?></textarea></td>
    </tr>
    <tr bgcolor=""> 
      <td>&nbsp;</td>
